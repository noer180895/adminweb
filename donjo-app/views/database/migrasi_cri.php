    ...
    <td style="background:#fff;padding:0px;">
      ...
      <div id="contentpane">
        <div class="ui-layout-north panel">
          <h3>Migrasi Database Ke Admin Desa <?php echo AmbilVersi()?></h3>
        </div>
               ...
               <table class="form">
                <tr>
                  <td width="500" colspan="3">
                    <p font-size="14px";>
                      Proses ini untuk mengubah database SID ke struktur database Admin Desa <?php echo AmbilVersi()?>.
                      <br><br>
                      ...
                      <ul>
                        <li>
                          <a href="https://terkoding.com">https://terkoding.com</a>, dan di
                        </li>
                        <li>
                          <a href="https://www.facebook.com/groups/Terkoding/">https://www.facebook.com/groups/terkoding/</a>
                        </li>
                    </p>
                  </td>
                  <td>

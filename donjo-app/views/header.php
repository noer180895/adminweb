...
<div class="ui-layout-north" id="header">
	...
	<div id="sid-info"><?php
		if($desa['nama_desa'] != ''){
		 echo ucwords($this->setting->sebutan_desa." ".$desa['nama_desa'].", ".$this->setting->sebutan_kecamatan." ".unpenetration($desa['nama_kecamatan']).", ".$this->setting->sebutan_kabupaten." ".unpenetration($desa['nama_kabupaten']));
		}
		?></div>

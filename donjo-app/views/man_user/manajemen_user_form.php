...
<input type="radio" id="group4" name="id_grup" value="4"/<?php if($user['id_grup'] == '4' OR $user['id_grup'] == ''){echo $ch;}?>><label for="group4">Kepala Desa</label>
...
<td>
 ...
 <option value="<?php echo $dt['id']?>" <?php if($dt['id'] == $user['id_desa']) :?>selected<?php endif?>><?php echo ununderscore(unpenetration($dt['nama_desa']))?></option>
                    <?php }?></option>

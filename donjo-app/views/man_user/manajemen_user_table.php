...
<div id="contentpane">
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
        <div class="table-panel top">
            <div class="left">
                <select name="filter" onchange="formAction('mainform','<?php echo site_url('man_user/filter')?>')">
                    ...
                    <option value="4" <?php if($filter==4) :?>selected<?php endif?>>Kepala Desa</option>
                </select>
            </div>
            <div class="right">
		...
		<thead>
            <tr>
                ...
                <?php  if($o==2): ?>
							...
							<?php  endif; ?>
								<th align="center" width='160' align="center">Kadaluarsa Akun</th>
		...
		<tr>
          ...
          <td><?php echo tgl_indo($data['expired_login'])?></td>

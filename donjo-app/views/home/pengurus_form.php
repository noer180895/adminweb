...
<div id="contentpane">
<div class="ui-layout-north panel"><h3>Form Pemnambahan Desa</h3>
</div>
        ...
        <table class="form">
            ...
            <tr>
              ...
              <td><input type="file" name="foto" /> <span style="color: #aaa;">(Kosongkan jika tidak ingin mengubah foto)</span></td>
                ...
                <?php if($isshow == 0){ ?>
                <input type="hidden" name="id_desa" id="id_desa" value="<?php echo $desa[0]['id_desa']; ?>">
                <?php }else{ ?>
                    <tr>
                    <th>Desa</th>
                    <td>
 ...
 <option value="<?php echo $dt['id']?>" <?php if($dt['id'] == $pamong['id_desa']) :?>selected<?php endif?>><?php echo ununderscore(unpenetration($dt['nama_desa']))?></option>
                    <?php }?></option>

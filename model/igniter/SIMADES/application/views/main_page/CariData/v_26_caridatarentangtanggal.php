        ...
        <div class="module-body">
            ...
            <table id="example" class="display nowrap">
                    ...
                    <tbody>
                            <?php
                                $a=0;
                                foreach ($ambildataasalusulrentang as $rowasalusul) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatabelummenikahrentang as $rowbelummenikah) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                            
                                ...
                                foreach ($ambildatadomisilirentang as $rowdomisili) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php    
                                ...
                                foreach ($ambildatadomisiliperusahaanrentang as $rowdomisiliperusahaan) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                            
                                ...
                                foreach ($ambildatakelahiranrentang as $rowkelahiran) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php
                                ...
                                foreach ($ambildatakematianrentang as $rowkematian) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                             
                                ...
                                foreach ($ambildatapembuatanskckrentang as $rowpembuatanskck) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                           
                                ...
                                foreach ($ambildatapermohonanimbrentang as $rowpermohonanimb) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php               
                                ...
                                foreach ($ambildatapindahrentang as $rowpindah) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatatentangorangtuarentang as $rowtentangorangtua) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatatidakmampurentang as $rowtidakmampu) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php             
                                ...
                                foreach ($ambildatauntuknikahrentang as $rowuntuknikah) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatawalirentang as $rowwali) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatawargarentang as $rowwarga) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildataizinkeramaianrentang as $rowizinkeramaian) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapengantarpembuatankkrentang as $rowpengantarpembuatankk) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapengantarpembuatanktprentang as $rowpengantarpembuatanktp) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapermohonanaktakelahiranrentang as $rowpermohonanaktakelahiran) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapermohonankkdinasrentang as $rowpermohonankkdinas) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapermohonanktpdinasrentang as $rowpermohonanktpdinas) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatapersetujuanmempelairentang as $rowpersetujuanmempelai) {
                                    $a++;
                            ?>
                            <tr>
                                <?php
                            ...
                            <?php                     
                                ...
                                foreach ($ambildatatugasdesarentang as $rowtugasdesa) {
                                    $a++;
                            ?>
                            <tr>
                                <?php

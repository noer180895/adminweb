        ...
        <div class="module">
            <div class="module-head">
                ...
                <div class="module-body">
                    <table id="example"  cellspacing="0" width="100%" class="display nowrap">
                        <thead>
                            <tr>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->tempat_lahir_pria." / ".$rowsurat->tanggal_lahir_pria."</td>
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->tempat_lahir_wanita." / ".$rowsurat->tanggal_lahir_wanita."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Keterangan Asal Usul '+today,

                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->tempat_lahir_ayah." / ".$rowsurat->tanggal_lahir_ayah."</td>
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->tempat_lahir_ibu." / ".$rowsurat->tanggal_lahir_ibu."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Keterangan tentang Orang Tua '+today,

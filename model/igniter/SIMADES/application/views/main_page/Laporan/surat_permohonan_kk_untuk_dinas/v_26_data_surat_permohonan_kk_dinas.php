    ...
    <div class="content">
        <div class="module">
            <div class="module-head">
                <h3>Laporan Surat Permohonan KK untuk Dinas</h3>
            </div>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->no_ktp."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Permohonan KK untuk Dinas '+today,

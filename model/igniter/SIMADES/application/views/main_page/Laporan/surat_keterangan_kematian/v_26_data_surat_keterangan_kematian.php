    ...
    <div class="content">
        <div class="module">
            <div class="module-head">
                <h3>Laporan Surat Keterangan Kematian</h3>
            </div>
                    ...
                    <table cellpadding="0" id="example"  class="display nowrap" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="jaraktabel">Hari/Tanggal</th>
                                <th class="jaraktabel">Jam</th>
                                <th class="jaraktabel">Pada Usia</th>
                                <th class="jaraktabel">Dikarenakan</th>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->hari_mati." / ".$rowsurat->tanggal_mati."</td>
                                                <td class='jaraktabel'>".$rowsurat->jam."</td>
                                                <td class='jaraktabel'>".$rowsurat->pada_usia."</td>
                                                <td class='jaraktabel'>".$rowsurat->dikarenakan."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Keterangan Kematian '+today,

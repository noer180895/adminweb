                    ...
                    <table cellpadding="0" id="example" class="display nowrap" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="jaraktabel">Tanggal Lahir</th>
                                <th class="jaraktabel">Kewarganegaraan</th>
                                <th class="jaraktabel">Agama</th>
                                <th class="jaraktabel">Pendidikan</th>
                                <th class="jaraktabel">Alamat</th>
                                <th class="jaraktabel">Keperuntukan</th>
                                <th class="jaraktabel">Tanggal Awal</th>
                                <th class="jaraktabel">Tanggal Akhir</th>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->tempat_lahir."</td>
                                                <td class='jaraktabel'>".TanggalIndodua($rowsurat->tanggal_lahir)."</td>
                                                <td class='jaraktabel'>".$rowsurat->kewarganegaraan."</td>
                                                <td class='jaraktabel'>".$rowsurat->agama."</td>
                                                <td class='jaraktabel'>".$rowsurat->pendidikan."</td>
                                                <td class='jaraktabel'>".$rowsurat->alamat."</td>
                                                <td class='jaraktabel'>".$rowsurat->untuk."</td>
                                                <td class='jaraktabel'>".TanggalIndodua($rowsurat->tanggal_awal)."</td>
                                                <td class='jaraktabel'>".TanggalIndodua($rowsurat->tanggal_akhir)."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Perintah Tugas '+today,

    ...
    <div class="content">
        <div class="module">
            <div class="module-head">
                <h3>Laporan Surat Keterangan untuk Nikah</h3>
            </div>
                    ...
                    <table cellpadding="0" id="example" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="jaraktabel">Bin/Binti</th>
                                <th class="jaraktabel">Status Perkawinan</th>
                                <th class="jaraktabel">Nama IStri/Suami Dulu</th>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->bin_binti."</td>
                                                <td class='jaraktabel'>".$rowsurat->status_perkawinan."</td>
                                                <td class='jaraktabel'>".$rowsurat->nama_istri_suami_dulu."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Keterangan Nikah '+today,

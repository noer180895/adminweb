    ...
    <div class="content">
        <div class="module">
            <div class="module-head">
                <h3>Laporan Surat Permohonan KTP untuk Dinas</h3>
            </div>
                    ...
                    <table cellpadding="0" id="example" class="display nowrap" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="jaraktabel">Golongan Darah</th>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->golongan_darah."</td>
            ...
            buttons: [
                        {
                           ...
                           header: true,
                           title: 'Export Data Surat Permohonan KTP untuk Dinas '+today,

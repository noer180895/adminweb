    ...
    <div class="content">
        <div class="module">
            <div class="module-head">
                <h3>Laporan Surat Keterangan Domisili Perusahaan</h3>
            </div>
                    ...
                    <table cellpadding="0" id="example" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="jaraktabel">Nama Perusahaan</th>
                                <th class="jaraktabel">alamat Perusahaan</th>
                                <th class="jaraktabel">Nomor Telepon</th>
                                <th class="jaraktabel">Jenis Usaha</th>
                                <th class="jaraktabel">Akta Pendirian</th>
                                <th class="jaraktabel">Jam Kerja</th>
                                <th class="jaraktabel">Jumlah Karyawan</th>
                                <th class="jaraktabel">Tanggal Surat</th>
                                <th class="jaraktabel">Penanda Tangan Kecamatan</th>
                                <th class="jaraktabel">Penanda Tangan Kelurahan</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr>
                                    ...
                                    <tr onClick="ambildata('<?php echo $a;?>')">
                                        <?php
                                            echo 
                                                ...
                                                <td class='jaraktabel'>".$rowsurat->nama_perusahaan."</td>
                                                <td class='jaraktabel'>".$rowsurat->alamat_perusahaan."</td>
                                                <td class='jaraktabel'>".$rowsurat->nomor_telepon."</td>
                                                <td class='jaraktabel'>".$rowsurat->jenis_usaha."</td>
                                                <td class='jaraktabel'>".$rowsurat->akta_pendirian."</td>
                                                <td class='jaraktabel'>".$rowsurat->jam_kerja."</td>
                                                <td class='jaraktabel'>".$rowsurat->jumlah_karyawan."</td>
                                                <td class='jaraktabel'>".$rowsurat->tanggal."</td>
                                                <td class='jaraktabel'>".$rowsurat->penanda_tangan_kecamatan."</td>
                                                <td class='jaraktabel'>".$rowsurat->penanda_tangan_kelurahan."</td>
                                                ";
                                        ?>
                                    </tr>      
                                <?php

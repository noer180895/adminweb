                            ...
                            <div class="module-body">
                                ...
                                <fieldset>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                            <p class="span2">RT </p>:   <input class="span4"  type="number" name="rt" placeholder="Diisi RT suami .." required></input>  <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">RW </p>:   <input class="span4"  type="number" name="rw" placeholder="Diisi RW suami .." required></input>  <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Nama </p>:   <input class="span4"  type="text" name="nama" placeholder="Diisi nama suami .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Bin </p>:   <input class="span4"  type="text" name="bin" placeholder="Diisi bin dari suami .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Tempat Lahir </p>:   <input class="span4"  type="text" name="tmptlahir" placeholder="Diisi tempat lahir suami .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Tanggal Lahir </p>:   <input class="span4"  type="date" name="tgllahir" placeholder="Diisi tanggal lahir suami .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" required placeholder="Diisi alamat suami .."></textarea>  <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                            <p class="span2">Kewarganegaraan </p>:   <input class="span4"  type="text" name="kewarganegaraan" placeholder="Diisi kewarganegaraan suami .." required></input> <br> 
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>

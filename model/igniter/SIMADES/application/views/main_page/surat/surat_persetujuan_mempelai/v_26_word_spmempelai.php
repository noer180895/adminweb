<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Persetujuan Mempelai '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_lahir_suami." / ".TanggalIndodua($rowsurat->tanggal_lahir_suami);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_lahir_istri." / ".TanggalIndodua($rowsurat->tanggal_lahir_istri);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

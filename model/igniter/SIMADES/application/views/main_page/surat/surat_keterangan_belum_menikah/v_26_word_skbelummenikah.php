<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Belum Menikah '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN BELUM MENIKAH</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			<td style="padding-left: 30px;padding-right: 30px" colspan="3">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang  tersebut diatas, adalah benar-benar warga kami dengan <b>status belum menikah.</b> Surat keterangan ini dibuat untuk keperluan <?php echo $rowsurat->tujuan;?>.</p>
			</td>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan belum menikah ini kami buat, untuk dapat dipergunakan sebagaimana mestinya.</p>
			</td>
		</tr>	
		</table>
		<br>

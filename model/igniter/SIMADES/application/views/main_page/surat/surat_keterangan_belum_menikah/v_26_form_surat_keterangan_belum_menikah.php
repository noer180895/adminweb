    ...
    <div class="content">
        ...
        <div class="module">
            ...
            <div class="module-body">
                ...
                <fieldset>
                    <legend>Data Keperluan Surat Ini :</legend>
                <table width="100%">
                <tr>
                    <td>
                    <p class="span2">Untuk Keperluan </p>:   <input class="span4" required placeholder="Diisi Keperluan Pembuatan Surat Belum Menikah Ini .." type="text" name="keperluan" value=""></input> <br> 
                    </td>
                </tr>
                </table>
                </fieldset>

                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <tr>
                                    <td>
                                        <p class="span2">No KK </p>:  <input type="text" name="nokk" class="span4" required placeholder="Diisi Nomor KK yang memohon .. "></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="span2">No NIK </p>:  <input type="text" class="span4" name="nonik" required placeholder="Diisi nomor NIK yang memohon .. "></input>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Nama </p>:   <input class="span4"  type="text" name="nama" placeholder="Diisi Nama yang memohon .." required></input> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tempat Lahir</p>:   <input class="span4"  type="text" name="tmptlahir" placeholder="Diisi tempat lahir yang memohon .." required></input> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tanggal Lahir </p>:   <input class="span4"  type="date" name="tgllahir" placeholder="Diisi tanggal lahir yang memohon" required></input>   
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" placeholder="Diisi dengan alamat asal pemohon .."></textarea> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Kewarganegaraan </p>:   <input  class="span4" type="text" name="kewarganegaraan" placeholder="Diisi dengan kewarganegaraan pemohon .." required></input>    
                                    </td>
                                </tr>
                                <tr>
                                    <td>

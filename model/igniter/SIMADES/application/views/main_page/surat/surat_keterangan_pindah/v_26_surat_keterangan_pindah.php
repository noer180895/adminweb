<div class="content">
	...
	?>
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_lengkap;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_desa;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_kecamatan;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_kabupaten;?></p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->pindah_ke;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_desa_baru;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_kecamatan_baru;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_kabupaten_baru;?></p>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->alasan_pindah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

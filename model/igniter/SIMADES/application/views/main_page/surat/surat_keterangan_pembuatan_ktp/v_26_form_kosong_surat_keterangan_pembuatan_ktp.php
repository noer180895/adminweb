                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpanskpembuatanktp" method="POST">
                                <?php
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" placeholder="Diisi alamat yang bersangkutan .. " required></textarea>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>

<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Tidak Mampu '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN TIDAK MAMPU</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			<td style="padding-left: 30px;padding-right: 30px" colspan="3">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang  tersebut diatas, adalah benar-benar <b>warga tidak mampu</b> dan berdomisili di RT. <?php echo $rowsurat->rt;?> RW. <?php echo $rowsurat->rw;?> Desa <?php echo $rowsurat->nama_desa;?> Kecamatan <?php echo $rowsurat->nama_kecamatan;?> Kabupaten <?php echo $rowsurat->nama_kabupaten;?>.</p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan tidak mampu ini kami buat, untuk dapat dipergunakan sebagaimana mestinya.</p>
			</td>
		</tr>	
		</table>
		<br>

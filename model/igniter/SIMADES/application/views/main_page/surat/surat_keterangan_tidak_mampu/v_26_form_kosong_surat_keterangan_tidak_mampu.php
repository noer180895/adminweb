                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpansktidakmampu" method="POST">
                                <?php
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Tempat Lahir </p>:   <input class="span4"  type="text" name="tmptlahir" placeholder="Diisi tempat lahir yang memohon .." required></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Tanggal Lahir </p>:   <input class="span4"  type="date" name="tgllahir" placeholder="Diisi tanggal lahir yang memohon .." required></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" required placeholder="Diisi alamat yang memohon .."></textarea>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>

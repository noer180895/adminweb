<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Tentang Orang Tua '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN TENTANG ORANG TUA</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->kewarganegaraan_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->alamat_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->kewarganegaraan_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->alamat_ibu;?></p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan tentang orang tua ini kami buat, untuk dapat dipergunakan sebagaimana mestinya.</p>
			</td>
		</tr>	
		</table>
		<?php

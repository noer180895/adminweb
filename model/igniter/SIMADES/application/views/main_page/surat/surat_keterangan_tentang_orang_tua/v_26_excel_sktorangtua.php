<?php
	...
	header("Content-Disposition: attachment; filename=Surat Keterangan tentang Orang Tua.xls");
?>
<div class="content">
<?php 
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_tanggal_lahir_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->kewarganegaraan_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->agama_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->pekerjaan_ayah;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_tanggal_lahir_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->kewarganegaraan_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->agama_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->pekerjaan_ibu;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

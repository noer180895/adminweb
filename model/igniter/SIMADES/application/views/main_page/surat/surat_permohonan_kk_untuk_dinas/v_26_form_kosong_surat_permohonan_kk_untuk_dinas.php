                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Tempat Lahir </p>:   <input class="span4"  type="text" name="tempatlahir" placeholder="Diisi tempat lahir yang bersangkutan .." required></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Tanggal Lahir </p>:   <input class="span4"  type="date" name="tanggallahir" placeholder="Diisi tanggal lahir yang bersangkutan .." required></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Nomor KTP </p>:   <input  class="span4" type="text" name="noktp" placeholder="Diisi nomor NIK atau KTP pemohon .." required></input>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" required placeholder="Diisi alamat pemohon .."></textarea>  <br>
                                        </td>
                                    </tr>
                                </table>
                                </fieldset>

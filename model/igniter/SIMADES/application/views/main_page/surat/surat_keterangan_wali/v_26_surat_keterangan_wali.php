...
?>
		...
		<table width="100%" border="0" style="padding-left: 60px">
		<tr>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->agama_dua;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->alamat_dua;?></p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan wali ini kami buat, untuk dapat dipergunakan sebagaimana mestinya</p>
			</td>
		</tr>	
		</table>
		<br>

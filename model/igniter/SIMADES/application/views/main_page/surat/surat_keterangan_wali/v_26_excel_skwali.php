<?php
	...
	header("Content-Disposition: attachment; filename=Surat Keterangan wali.xls");
?>
<div class="content">
<?php
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->umur;?> Tahun</p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->umur_dua;?> Tahun</p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->umur_tiga?> Tahun</p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

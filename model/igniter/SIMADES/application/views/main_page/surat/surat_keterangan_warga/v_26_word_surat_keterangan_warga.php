<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Warga '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN WARGA</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			<td style="padding-left: 30px;padding-right: 30px" colspan="3">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Warga tersebut adalah benar-benar penduduk Desa <?php echo $rowsurat->nama_desa;?> Kecamatan <?php echo $rowsurat->nama_kecamatan;?> Kabupaten <?php echo $rowsurat->nama_kabupaten;?>, Surat Keterangan ini dipergunakan sebagai identitas diri.</p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan Warga ini kami buat, untuk dapat dipergunakan sebagaimana mestinya.</p>
			</td>
		</tr>	
		</table>
		<br>

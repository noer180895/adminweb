                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <tr>
                                    <td>
                                    <br>
                                    <p class="span2">Nama ayah</p>:   <input class="span4" required placeholder="Diisi Nama Ayah" type="text" name="namaayah" id="namaayah"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tempat Lahir ayah</p>:   <input class="span4" required placeholder="Diisi Tempat Lahir Ayah" type="text" name="tmptlahirayah" id="tmptlahirayah"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tanggal Lahir ayah</p>:   <input class="span4" required placeholder="Diisi Tanggal Lahir Ayah" type="date" name="tgllahirayah" id="tgllahirayah"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Agama Ayah</p>:   <select name="agamaayah" required id="agamaayah" class="span4">
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Pekerjaan ayah</p>:   <select name="pekerjaanayah" required class="span4">
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Kewarganegaraan ayah</p>:   <input class="span4" required placeholder="Diisi Kewarganegaraan Ayah" type="text" name="kewarganegaraanayah" id="kewarganegaraanayah"></input> <br> 
                                    </td>
                                </tr>
                                </table>
                                <legend></legend>
                               ...
                               <table width="100%">
                                <tr>
                                    <td>
                                    <br>
                                    <p class="span2">Nama ibu</p>:   <input class="span4" required placeholder="Diisi Nama Ibu" type="text" name="namaibu" id="namaibu"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tempat Lahir ibu</p>:   <input class="span4" required placeholder="Diisi Tempat Lahir Ibu" type="text" name="tmptlahiribu" id="tmptlahiribu"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Tanggal Lahir ibu</p>:   <input class="span4" required placeholder="Diisi Tanggal Lahir Ibu" type="date" name="tgllahiribu" id="tgllahiribu"></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Agama ibu</p>:   <select name="agamaibu" required id="agamaibu" class="span4">
                                                    <option value="Islam" name="islam" selected="">Islam</option>
                                                    <option value="Protestan" name="protestan">Protestan</option>
                                                    <option value="Khatolik" name="khatolik">Khatolik</option>
                                                    <option value="Hindu" name="hindu">Hindu</option>
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Kewarganegaraan ibu</p>:   <input class="span4" required placeholder="Diisi Kewarganegaraan Ibu" type="text" name="kewarganegaraanibu" id="kewarganegaraanibu"></input> <br> 
                                    </td>
                                </tr>
                                </table>
                                </fieldset>

...
function TanggalIndo($date){
	...
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Asal Usul '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->nama_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->tempat_lahir_pria." / ".TanggalIndodua($rowsurat->tanggal_lahir_pria);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->kewarganegaraan_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->agama_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->alamat_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px" colspan="5">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->nama_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->tempat_lahir_wanita." / ".TanggalIndodua($rowsurat->tanggal_lahir_wanita);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->kewarganegaraan_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p><?php echo $rowsurat->agama_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->alamat_wanita;?></p>
			</td>
		</tr>
		</table>
		<table width="100%">

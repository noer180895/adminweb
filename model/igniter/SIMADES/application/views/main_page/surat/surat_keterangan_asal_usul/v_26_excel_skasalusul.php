<?php
	...
	header("Content-Disposition: attachment; filename=Surat Keterangan Asal Usul.xls");
?>
<div class="content">
<?php
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_tanggal_lahir_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->pekerjaan_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->tempat_tanggal_lahir_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->pekerjaan_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

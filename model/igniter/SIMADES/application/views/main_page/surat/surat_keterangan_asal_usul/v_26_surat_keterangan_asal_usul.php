...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN ASAL USUL</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			<td style="padding-left: 50px" colspan="5">
				<p>Adalah benar anak kandung dari pernikahan seorang pria :</p>
			</td>
		</tr>
		<tr>
			<td height="10">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->tempat_lahir_pria." / ".TanggalIndodua($rowsurat->tanggal_lahir_pria);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->kewarganegaraan_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->agama_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->pekerjaan_pria;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->alamat_pria;?></p>
			</td>
		</tr>
		<tr>
			<td height="5">
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->nama_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->tempat_lahir_wanita." / ".TanggalIndodua($rowsurat->tanggal_lahir_wanita);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->kewarganegaraan_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->agama_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->pekerjaan_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->alamat_wanita;?></p>
			</td>
		</tr>
		<tr>
			<td height="5px">
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan asal usul ini kami buat, untuk dapat dipergunakan sebagaimana mestinya.</p>
			</td>
		</tr>	
		</table>
		<?php

    ...
    <div class="content">
        <div class="module">
            ...
            <div class="module-body">
                ...
                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpanskdomisili" method="POST">
                <?php
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        <td>
                        <p class="span2">RT </p>:   <input class="span4" required type="number" placeholder="Masukan rt yang bersangkutan .." name="rt"></input>  <br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                        <p class="span2">Nama </p>:   <input class="span4" required type="text" name="nama" placeholder="Diisi nama yang berdomisili .."></input> <br> 
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <p class="span2">Tempat Lahir </p>:   <input class="span4" required type="text" name="tmptlahir" placeholder="Diisi tempat lahir yang berdomisili .."></input> <br> 
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <p class="span2">Tanggal Lahir </p>:   <input class="span4" required type="date" name="tgllahir" placeholder="Diisi tanggal lahir yang berdomisili .."></input> <br> 
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p class="span2">Kewarganegaraan </p>:   <input required class="span4" type="text" placeholder="Diisi Kewarganegaraan sekarang .." name="kewarganegaraan"></input>  <br>
                        </td>
                    </tr>
                </table>
                </fieldset>
                <legend></legend>
                <fieldset>
                    <legend>Tujuan Berdomisili :</legend>
                <table>
                <tr>
                    <td>  
                    <p class="span2">Tujuan </p>:   <input required placeholder="Diisi Tujuan atau Alasan Berdomisili .." class="span4" type="text" name="tujuan">
                    </td>
                </tr>

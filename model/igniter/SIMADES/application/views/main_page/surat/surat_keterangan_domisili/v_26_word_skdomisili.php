<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Domisili '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td>
				<h3>
					<center>
						<p><u><b>SURAT KETERANGAN DOMISILI</b></u></p>
					</center>
				</h3>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->alamat;?> RT. <?php echo $rowsurat->rt;?> RW. <?php echo $rowsurat->rw;?></p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td style="padding-right: 30px;padding-left: 30px">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang  tersebut diatas, adalah <b>benar-benar warga kami dan berdomisili di</b>      RT. <?php echo $rowsurat->rt;?> RW. <?php echo $rowsurat->rw;?> Desa <?php echo $rowsurat->nama_desa;?> Kecamatan <?php echo $rowsurat->nama_kecamatan;?> Kabupaten <?php echo $rowsurat->nama_kabupaten;?>. Surat keterangan ini dibuat sebagai kelengkapan pengurusan <?php echo $rowsurat->tujuan;?>.</p>
				<br>
			</td>
		</tr>
		</table>

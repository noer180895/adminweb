                            ...
                            <div class="module-body">
                                ...
                                <fieldset>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                            <p class="span2">RT Ayah </p>:   <input class="span4"  type="number" name="rt" placeholder="Diisi RT ayah .." required></input>  <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">RW Ayah </p>:   <input class="span4"  type="number" name="rw" placeholder="Diisi RW ayah .." required></input>  <br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Nama Ayah </p>:   <input class="span4"  type="text" name="namaayah" placeholder="Diisi nama ayah .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Tempat Lahir Ayah </p>:   <input class="span4"  type="text" name="tempatlahirayah" placeholder="Diisi tempat lahir ayah .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Tanggal Lahir Ayah </p>:   <input class="span4"  type="date" name="tanggallahirayah" placeholder="Diisi tanggal lahir ayah .." required></input> <br> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <p class="span2">Agama Ayah </p>:   <select name="agamaayah" required class="span4">
                                        ...
                                        <tr>
                                            <td>
                                            <p class="span2">Alamat Ayah </p>:   <textarea name="alamatayah" class="span4" required placeholder="Diisi alamat ayah .."></textarea>  <br>
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>

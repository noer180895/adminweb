<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan Kematian '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->hari_mati." / ".TanggalIndodua($rowsurat->tanggal_mati);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

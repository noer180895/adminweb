...
?>
		...
		<tr>
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->hari_mati." / ".TanggalIndodua($rowsurat->tanggal_mati);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->jam;?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->pada_usia." (".$rowsurat->terbilang.") Tahun";?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
			...
			<td>
				<p style="text-transform: capitalize;"><?php echo $rowsurat->dikarenakan;?></p>
			</td>
		</tr>
		<tr>
			<td>

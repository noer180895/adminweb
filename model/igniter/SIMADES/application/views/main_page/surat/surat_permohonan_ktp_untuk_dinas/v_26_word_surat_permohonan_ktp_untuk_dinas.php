<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Permohonan KTP untuk Dinas '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			<td rowspan="4" width="100px">
					<img src="<?php echo $rowperangkat->logo_desa;?>" width="100px" height="120px">
			</td>
			<td>
				<h3>
					<center>

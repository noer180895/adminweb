                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpanspermohonanktpdinas" method="POST">
                                <?php
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Tempat Lahir </p>:   <input class="span4"  type="text" name="tempatlahir" placeholder="Diisi tempat lahir pemohon .. " required></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Golongan Darah </p>:   <select name="golongandarah" required class="span4">
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" required placeholder="Diisi alamat tinggal pemohono .."></textarea>  <br>
                                        </td>
                                    </tr>
                                </table>
                                </fieldset>

<?php
	$a = date('H')+5;
	$nama_dokumen='Surat Keterangan untuk Nikah '.TanggalIndo(date('d m Y'))."_".date($a.':i:s a'); //Beri nama file PDF hasil.
...
?>
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->bin_binti?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">
		...
		<tr>
			...
			<td>
				<p><?php echo $rowsurat->nama_istri_suami_dulu;?></p>
			</td>
		</tr>
		<tr>
			<td>

                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpansknikah" method="POST">
                                <?php
                                ...
                                ?>
                                <fieldset>
                                    <legend>Data Orang</legend>
                                <table width="100%">
                                    <tr>
                                        <td>
                                        <p class="span2">Kecamatan </p>:   <input class="span4" type="text" required name="namakecamatan" value="<?php echo $rowperangkat->nama_kecamatan; ?>" ></input><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Kabupaten </p>:   <input class="span4"  type="text" required name="namakabupaten" value="<?php echo $rowperangkat->nama_kabupaten; ?>" ></input>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Desa </p>:   <input class="span4"  type="text" required name="namadesa" value="<?php echo $rowperangkat->nama_desa; ?>" ></input>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">RT </p>:   <input class="span4"  type="text" name="rt" required placeholder="Diisi RT yang bersangkutan .. "></input>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">RW </p>:   <input class="span4"  type="text" name="rw" required placeholder="Diisi RW yang bersangkutan .. "></input>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Nama </p>:   <input class="span4"  type="text" name="nama" required placeholder="Diisi nama yang bersangkutan .." ></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                        <p class="span2">Tempat Lahir </p>:   <input class="span4" required type="text" name="tmptlahir" placeholder="Diisi tempat lahir yang bersangkutan .." ></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Tanggal Lahir </p>:   <input class="span4" required type="date" name="tgllahir" placeholder="Diisi tanggal lahir yang bersangkutan .. " ></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Alamat </p>:   <textarea name="alamat" class="span4" placeholder="Diisi alamat yang bersangkutan .."></textarea>  <br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <p class="span2">Kewarganegaraan </p>:   <input class="span4"  type="text" name="kewarganegaraan" placeholder="Diisi Kewarganegaraan yang bersangkutan .." ></input> <br> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <fieldset>
                                    <legend>Data Nikah</legend>
                                </fieldset>
                                <table>
                                <tr>
                                    <td>
                                    <p class="span2">Bin / Binti </p>:   <input class="span4" required placeholder="Nama Bin atau Binti" type="text" name="binbinti" ></input> <br> 
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    <p class="span2">Status Perkawinan </p>:   
                                        <select name="statusperkawinan" required class="span4">
                                ...
                                <tr>
                                    <td>
                                    <p class="span2">Nama istri suami dulu </p>:   <input class="span4" placeholder="Nama Istri atau Suami dulu Jika ada .." type="text" name="namaistrisuamidulu" ></input> <br> 
                                    </td>
                                </tr>

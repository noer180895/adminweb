...
?>
		...
		<table width="100%">
			<tr>
				...
				<td>
					<table width="100%" border="0" style="padding-left: 150px">
						<tr>
							<td>
								<p></p>
							</td>
		...
		<tr>
			...
			<td>
				<p><?php echo TanggalIndodua($rowsurat->waktu_pelaksanaan_awal)." - ".TanggalIndodua($rowsurat->waktu_pelaksanaan_akhir);?></p>
			</td>
		</tr>
		<tr>
			<td style="padding-left: 50px">

                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form action="<?php echo base_url()?>surat/c_26_data_surat/simpanspizinkeramaian" method="POST">
                                <?php
                                ...
                                <fieldset>
                                    ...
                                    <table width="100%">
                                            <tr>
                                                <td>
                                                <p class="span2">Lampiran </p>:   <input type="text" class="span4" required name="lampiran" placeholder="Diisi ada berapa lampiran untuk surat ini .."></input> <br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Kepada </p>:   <input type="text" class="span4" required name="kepada" placeholder="Diisi tempat kepala dinas perhubungan tujuan surat ini .."></input> <br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                <p class="span2">Nama</p>:   <input class="span4"  type="text" name="nama" placeholder="Diisi nama pemohon .." required></input> <br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Tanggal Lahir </p>:   <input  class="span4" type="date" name="tanggallahir" placeholder="diisi tanggal lahir pemohon .." required></input>  <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Jenis Kelamin </p>:   <select name="jeniskelamin" required class="span4">
                                ...
                                <br>
                                <fieldset>
                                    <legend>Detail Izin Keramaian</legend>

                                            <table width="100%">
                                            <tr>
                                                <td>
                                                <p class="span2">Penyampai </p>:   <input type="text" name="penyampai" class="span4" placeholder="Diisi nama yang menyampaikan/memberitahu informasi kepada desa .."></input>  <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Acara </p>:   <input type="text" name="acara" class="span4" placeholder="Diisi acar yang akan diselenggarakan .."></input>  <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Waktu Pelaksanaan </p>:   <input type="date" name="waktupelaksanaanawal" class="span2" placeholder="Diisi waktu pelaksanaan awal .."></input> s/d <input type="date" name="waktupelaksanaanakhir" class="span2" placeholder="Diisi waktu pelaksanaan akhir .."></input>  <br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                <p class="span2">Alamat / Tempat </p>:   <textarea name="tempat" placeholder="Diisi dengan alamat atau tempat dilaksanakan acara" required class="span4"></textarea>  <br>
                                                </td>
                                            </tr>
                                            </table>
                                    <legend></legend>

...
* 
*/
class C_26_data_perusahaan extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = array(
			'view' => 'main_page/Data_Perusahaan/v_26_data_perusahaan',
				'ambildataperusahaan' => $this->m_26_data_perusahaan->ambildata(),
			);
	...
	public function lihat()
	{
		$id = $_GET['id'];
		$data = array(
			'view' => 'main_page/Data_Perusahaan/v_26_lihat_data_perusahaan',
			'ambil' => $this->m_26_data_perusahaan->ambildataberdasarkan($id),
			);
		$this->load->view('v_23_index',$data);

				$aksi 	= 'Melihat data perusahaan';
				$this->m_log->log($aksi);
	}

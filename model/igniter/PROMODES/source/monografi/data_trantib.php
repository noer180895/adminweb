...
if($r == 0){
    ...
    while($d1 = mysql_fetch_array($s1)){
        ...
        $_s11 = mysql_query("select * from tbinput_monografi where idkat='7' and  idmain = '$d1[id]' and nilai != '' and bulan = '$bulan' and tahun ='$tahun'");
        ...
        if(($_r1 != 0 && $_r11 != 0) || ($_r1 != 0 && $_d1['nilai'] != "")){
            ...
            while($d2 = mysql_fetch_array($s2)){
                ...
                $_s12 = mysql_query("select * from tbinput_monografi where idkat='7' and  idsub2 = '$d2[id]' and nilai != '' and bulan = '$bulan' and tahun ='$tahun'");

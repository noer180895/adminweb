...
echo "<h2>PEMASARAN HASIL GALIAN</h2>";


if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_sda where idkat = '2' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/bahan_galian/pemasaran_galian/tahun/'+$tahun.val(),

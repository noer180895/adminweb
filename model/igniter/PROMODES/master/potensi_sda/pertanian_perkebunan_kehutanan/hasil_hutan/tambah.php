...
if(isset($_POST['simpan'])){
    ...
    else
    {
        ...
        while($d1 = mysql_fetch_array($s1)){
            ...
            $q = mysql_query("insert into tbinput_p2k(idkat,idunik,idsub,tipe,nilai,tahun) values('4','$idunik','$d1[id]','0','$val','$tahun')");
        }
...
while($d1 = mysql_fetch_array($s1)){
    echo "<tr>
            <td>$d1[nama]</td>
            <td><input type='text' name ='hasil$d1[id]'/> $d1[satuan]</td>
        </tr>";
}
echo "<tr>

...
if(isset($_POST['simpan'])){
    ...
    else
    {
        ...
        while($d1 = mysql_fetch_array($s1)){
            ...
            $q = mysql_query("insert into tbinput_p2k(idkat,idunik,idsub,tipe,nilai,tahun) values('5','$idunik','$d1[id]','0','$val','$tahun')");
        }
        if($q){
...
while($d1 = mysql_fetch_array($s1)){
    echo "<tr>
            <td>$d1[nama]</td>
            <td align=right><input type='text' name ='baik$d1[id]'/> Ha</td>
            <td align=right><input type='text' name ='buruk$d1[id]'/> Ha</td>
        </tr>";
}
echo "<tr>

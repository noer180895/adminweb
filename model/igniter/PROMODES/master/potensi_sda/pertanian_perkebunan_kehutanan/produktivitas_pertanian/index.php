...
if($mod == "hapus"){
    ...
    $q = mysql_query("delete from tbinput_p2k where idkat = '2' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/pertanian_perkebunan_kehutanan/produktivitas_pertanian/tahun/'+$tahun.val(),

...
if($mod == "hapus"){
    ...
    $q = mysql_query("delete from tbinput_p2k where idkat = '3' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/pertanian_perkebunan_kehutanan/hasil_perkebunan/tahun/'+$tahun.val(),

...
echo "<h2>SUMBER AIR DAN KUALITAS AIR MINUM</h2>";


if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_sda where idkat = '4' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/sumber_daya_air/sumber_air/tahun/'+$tahun.val(),

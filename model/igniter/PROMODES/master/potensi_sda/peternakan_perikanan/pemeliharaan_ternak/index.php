...
echo "<h2>KETERSEDIAAN LAHAN PEMELIHARAAN TERNAK/PADANG PENGGEMBALAAN</h2>";

 
if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_p2 where idkat = '5' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/peternakan_perikanan/pemeliharaan_ternak/tahun/'+$tahun.val(),

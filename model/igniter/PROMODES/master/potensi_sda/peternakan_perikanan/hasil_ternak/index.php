...
echo "<h2>PEMILIK USAHA PENGOLAHAN HASIL PETERNAKAN</h2>";

 
if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_p2 where idkat = '4' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/psda/peternakan_perikanan/hasil_ternak/tahun/'+$tahun.val(),

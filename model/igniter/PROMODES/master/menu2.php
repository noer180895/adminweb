        ...
        <ul class="widget widget-menu unstyled">
            <li><a class="collapsed" data-toggle="collapse" href="#PSDM"><i class="menu-icon icon-cog">
                ...
                <ul id="PSDM" class="collapse unstyled">
                    <li><a Href='<?php echo $server; ?>/psdm/kepadatan/'>Kepadatan</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/perkembangan_usia/'>Perkembangan Usia</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/tingkat_pendidikan/'>Tingkat Pendidikan</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/mata_pencarian/'>Mata Pencarian Pokok</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/aliran_kepercayaan/'>Agama/Aliran Kepercayaan</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/kewarganegaraan/'>Kewarganegaraan</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/etnis/'>Etnis</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/cacat_mental/'>Cacat Mental Dan Fisik</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/tenaga_kerja/'>Tenaga Kerja</a></li>
                    <li><a Href='<?php echo $server; ?>/psdm/kualitas_angker/'>Kualitas Angkatan Kerja</a></li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="widget widget-menu unstyled">
            <li>
                ...
                <ul id="PSdP" class="collapse unstyled">
                    ...
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/sarpras_lembaga/'>Lembaga Kemasyarakatan Desa/Kelurahan</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/sarpras_kesehatan/'>Kesehatan</a></li>
                    ...
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/sarpras_kebersihan/'>Kebersihan</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/sarpras_pendidikan/'>Pendidikan</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_kominfo/'>Prasarana Komunikasi Dan Informasi</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_air/'>Prasarana Air Bersih Dan Sanitasi</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_irigasi/'>Prasarana Dan Kondisi Irigasi</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_peribadatan/'>Prasarana Peribadatan</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_olga/'>Prasarana Olah Raga</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_energi/'>Prasarana Energi Dan Penerangan</a></li>
                    <li><a Href='<?php echo $server; ?>/potensi_sarpras/prasarana_hiburan/'>Prasarana Hiburan Dan Wisata</a></li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="widget widget-menu unstyled">
            <li>
                ...
                <ul id="LembagaEkonomi" class="collapse unstyled">
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/lembaga_ekonomi/'>Lembaga Ekonomi</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_pengangkutan/'>Usaha Jasa Pengangkutan</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_hiburan/'>Usaha Jasa Hiburan</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_perdagangan/'>Usaha Jasa Dan Perdagangan</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_gas/'>Usaha Jasa Gas, Listrik, Bbm Dan Air</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_keterampilan/'>Usaha Jasa Keterampilan</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_hukum/'>Usaha Jasa Hukum Dan Konsultasi</a></li>
                    <li><a Href='<?php echo $server; ?>/lembaga_ekonomi/jasa_penginapan/'>Usaha Jasa Penginapan</a></li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="widget widget-menu unstyled">
            <li>
                ...
                <ul id="MonoGrafiDesa" class="collapse unstyled">
                    <li><a href='<?php echo $server; ?>/monografi/data_dasar/'>Data Dasar</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_umum/'>Data Umum</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_personil/'>Data Personil</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_kewenangan/'>Data Kewenangan</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_keuangan/'>Data Keuangan</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_kelembagaan/'>Data Kelembagaan</a></li>
                    <li><a href='<?php echo $server; ?>/monografi/data_trantib/'>Data Trantib dan Bencana</a></li>
                </ul>
            </li>
        </ul>
    </div>

...
if(isset($_POST['simpan'])){
    ...
    else
    {
        ...
        while($d1 = mysql_fetch_array($s1)){
            ...
            $q = mysql_query("insert into tbinput_sarpras2(idkat,idunik,idsub,tipe,nilai,tahun) values('13','$idunik','$d1[id]','0','$prasarana','$tahun')");
        }
        if($q){
            echo "<script>window.location='$server/potensi_sarpras/prasarana_hiburan/';</script>";
        }
    }
}
?>

...
if($mod == "hapus"){
    ...
    $q = mysql_query("delete from tbinput_sarpras2 where idkat = '1' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/potensi_sarpras/sarpras_transportasi/prasarana_darat/tahun/'+$tahun.val(),

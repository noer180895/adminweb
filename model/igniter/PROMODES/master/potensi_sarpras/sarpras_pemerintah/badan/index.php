...
echo "<h2>PRASARANA DAN SARANA BADAN PEMASYARAKATAN DESA/BPD</h2>";


if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_sarpras where idkat = '2' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/potensi_sarpras/sarpras_pemerintah/badan/tahun/'+$tahun.val(),

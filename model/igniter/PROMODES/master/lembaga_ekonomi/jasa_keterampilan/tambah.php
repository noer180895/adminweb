...
if(isset($_POST['simpan'])){
    ...
    else
    {
        ...
        while($d1 = mysql_fetch_array($s1)){
            ...
            $q = mysql_query("insert into tbinput_lembaga(idkat,idunik,idsub,tipe,nilai,tahun) values('6','$idunik','$d1[id]','0','$val','$tahun')");
        }
        if($q){
...
while($d1 = mysql_fetch_array($s1)){
    echo "<tr>
            <td>$d1[nama]</td>
            <td><input type='text' name ='jumlah$d1[id]'/> Orang</td>

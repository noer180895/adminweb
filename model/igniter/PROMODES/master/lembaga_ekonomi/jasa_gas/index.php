...
echo "<h2>USAHA JASA GAS, LISTRIK, BMM DAN AIR</h2>";


if($mod == "hapus"){
    $tahun = abs((int)$_GET['tahun']);
    $q = mysql_query("delete from tbinput_lembaga where idkat = '5' and tahun = '$tahun'");
    if($q){
...
$(document).ready(function(){
    ...
    $tahun.change(function(){
        $.ajax({
            url:'<?php echo $server ?>/lembaga_ekonomi/jasa_gas/tahun/'+$tahun.val(),

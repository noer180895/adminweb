...
if(isset($_POST['simpan'])){
    $tahun2 = $_POST['tahun'];
    if($tahun != $tahun2){
        $s = mysql_query("select * from tbinput_lembaga where idkat = '3' and tahun ='$tahun2'");
        $r = mysql_num_rows($s);
        if($r != 0){
        ...
        else
        {
            ...
            while($d1 = mysql_fetch_array($s1)){
                ...
                $q = mysql_query("update tbinput_lembaga set nilai = '$val',tahun='$tahun' where idkat = '3' and idunik = '$idunik' and idsub = '$d1[id]'");
            }
            if($q){
...
$s1 = mysql_query("select * from tbjasa_hiburan order by posisi asc");
while($d1 = mysql_fetch_array($s1)){
    $_s1 = mysql_query("select * from tbinput_lembaga where idkat = '3' and idsub = '$d1[id]' and tahun = '$tahun'");
    ...
    if($_r1 != 0){
        echo "<tr>
                ...
                <td><input type='text' name ='kegiatan$d1[id]' value='$nilai[1]'/> Jenis</td>

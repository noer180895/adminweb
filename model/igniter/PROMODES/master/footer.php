...
?>
        ...
        </div> <!-- entahlah apa ini -->
		<div class="footer">
	        <div class="container">
	            <b class="copyright"> Copyright &copy Softindotech 2016</b> All rights reserved.
	        </div>
		</div>
	<script src="<?php echo $server ?>assets/scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/scripts/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/scripts/flot/jquery.flot.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/scripts/flot/jquery.flot.resize.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/scripts/datatables/jquery.dataTables.js" type="text/javascript"></script>
	<script src="<?php echo $server ?>assets/scripts/common.js" type="text/javascript"></script>

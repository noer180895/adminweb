                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_A_7/Buku_Data_Agenda_Desa/c_26_buku_Agenda_desa/" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggal" readonly autofocus value="<?php echo $row->tanggal?>" class="span8">
                                    </div>
                                </div>
                                <br><br>
                                <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="suratmasukdari" readonly autofocus class="span8" value="<?php echo $row->surat_masuk_dari?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Isi Singkat Surat Masuk</label>
                                    <div class="controls">
                                        : <textarea name="suratmasukisi" placeholder="isi singkat dari surat masuk" class="span8" readonly><?php echo $row->surat_masuk_isi?></textarea>
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="suratkeluarisi" placeholder="diisi perihal surat keluar" readonly class="span8"><?php echo $row->surat_keluar_isi?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Pengiriman</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggalpengiriman" readonly autofocus class="span8" value="<?php echo $row->surat_keluar_tanggal?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Alamat</label>
                                    <div class="controls">
                                        : <input type="text" name="alamat" readonly autofocus class="span8"  value="<?php echo $row->alamat?>">
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>

                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_C_3_c/Buku_Kas_Harian_Pembantu/c_26_buku_kas_harian_pembantu/ubahdata" method="POST"  class="form-horizontal row-fluid">
                            <input type="hidden" name="id" value="<?php echo $id?>"></input>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggal" maxlength="255"  autofocus value="<?php echo $row->tanggal?>" placeholder="Masukan Nama proyek yang direncanakan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Uraian</label>
                                    <div class="controls">
                                        : <textarea name="uraian" class="span8"  placeholder="masukan uraian seputar penerimaan atau pengeluaran"><?php echo $row->uraian?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Penerimaan (Rp)</label>
                                    <div class="controls">
                                        : <input type="number" name="penerimaan" maxlength="255"  id="penerimaan" onkeyup="hitung('penerimaan')" autofocus placeholder="Masukan Jumlah Rupiah Penerimaan Kas..." value="<?php echo $row->penerimaan?>" class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Pengeluaran (Rp)</label>
                                    <div class="controls">
                                        : <input type="number" name="pengeluaran" maxlength="255"  id="pengeluaran" onkeyup="hitung('pengeluaran')" autofocus placeholder="Masukan Jumlah Rupiah Pengeluaran Kas..." value="<?php echo $row->pengeluaran?>" class="span8">
                                    </div>
                                </div>
                                <div class="control-group">

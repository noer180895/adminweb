                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_E_1/Buku_Anggota_BPD/c_26_buku_anggota_bpd/" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="jabatan" maxlength="200" readonly autofocus  value="<?php echo $row->jabatan?>" class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <fieldset>
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalpengangkatan" maxlength="200" readonly autofocus  value="<?php echo $row->keputusan_pengangkatan_tanggal?>" class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor Pengangkatan</label>
                                    <div class="controls">
                                        : <input type="text" name="nomorpengangkatan" maxlength="200" readonly autofocus  value="<?php echo $row->keputusan_pengangkatan_nomor?>" class="span8">
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalpemberhentian" maxlength="200" readonly autofocus  value="<?php echo $row->keputusan_pemberhentian_tanggal?>"class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor Pemberhentian</label>
                                    <div class="controls">
                                        : <input type="text" name="nomorpemberhentian" maxlength="200" readonly autofocus  value="<?php echo $row->keputusan_pemberhentian_nomor?>" class="span8">
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>

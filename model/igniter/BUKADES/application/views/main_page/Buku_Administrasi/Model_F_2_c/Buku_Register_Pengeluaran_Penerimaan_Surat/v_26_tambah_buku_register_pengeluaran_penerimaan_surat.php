                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_F_2_c/Buku_Register_Pengeluaran_Penerimaan_Surat/c_26_buku_register_pengeluaran_penerimaan_surat/simpan" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalsuratketerangan" maxlength="200" required autofocus placeholder="Diisi tanggal surat keterangan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor Surat Keterangan</label>
                                    <div class="controls">
                                        : <input type="text" name="nomorsuratketerangan" maxlength="200" required autofocus placeholder="Diisi nomor surat keterangan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Isi dari surat keterangan</label>
                                    <div class="controls">
                                        : <textarea name="isisuratketerangan" required="" class="span8" placeholder="Isi singkat dari Surat Keterangan "></textarea>
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="nama" maxlength="200" required autofocus placeholder="Diisi Nama ..." class="span8">
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Lahir</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggallahir" required class="span8" placeholder="Diisi Tanggal Lahir"></input>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="alamat" required class="span8" placeholder="Diisi Alamat"></textarea>
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="digunakanuntuk" required class="span8" placeholder="Diisi digunakan untuk apa"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Berlaku Sampai Dengan</label>
                                    <div class="controls">
                                        : <input type="date" name="berlaku" required class="span8"></input>
                                    </div>
                                </div>
                                <div class="control-group">

                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_F_2_c/Buku_Register_Pengeluaran_Penerimaan_Surat/c_26_buku_register_pengeluaran_penerimaan_surat/ubahdata" method="POST"  class="form-horizontal row-fluid">
                            <input type="hidden" name="id" value="<?php echo $id?>"></input>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalsuratketerangan" maxlength="200"  autofocus value="<?php echo $row->tanggal_identitas?>" placeholder="Diisi tanggal surat keterangan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor Surat Keterangan</label>
                                    <div class="controls">
                                        : <input type="text" name="nomorsuratketerangan" maxlength="200"  autofocus value="<?php echo $row->nomor_identitas?>" placeholder="Diisi nomor surat keterangan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Isi dari surat keterangan</label>
                                    <div class="controls">
                                        : <textarea name="isisuratketerangan" ="" class="span8" placeholder="Isi singkat dari Surat Keterangan "><?php echo $row->tentang_identitas?></textarea>
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="nama" maxlength="200"  autofocus value="<?php echo $row->nama?>" placeholder="Diisi Nama ..." class="span8">
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Lahir</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggallahir"  class="span8" value="<?php echo $row->tanggal_lahir?>" placeholder="Diisi Tanggal Lahir"></input>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="alamat"  class="span8" placeholder="Diisi Alamat"><?php echo $row->alamat?></textarea>
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="digunakanuntuk"  class="span8" placeholder="Diisi diguanakn untuk apa"><?php echo $row->digunakan_untuk?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Berlaku S.D</label>
                                    <div class="controls">
                                        : <input type="date" name="berlaku"  class="span8"  value="<?php echo $row->berlaku?>"></input>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <a href="<?php echo base_url()?>Buku_Administrasi/Model_F_2_c/Buku_Register_Pengeluaran_Penerimaan_Surat/c_26_buku_register_pengeluaran_penerimaan_surat/" class="tombolhapus" style="float: left;">Kembali</a>
                                    <div class="controls">

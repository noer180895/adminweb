                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_B_4/Buku_Penduduk_Sementara/c_26_buku_penduduk_sementara/ubahdata" method="POST"  class="form-horizontal row-fluid">
                            <input type="hidden" name="id" value="<?php echo $id?>"></input>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tahun</label>
                                    <div class="controls">
                                        : <input type="text" name="tahun"  autofocus class="span8" value="<?php echo date('Y')?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nama Lengkap</label>
                                    <div class="controls">
                                        : <input type="text" name="namalengkap" value="<?php echo $row->nama_lengkap?>" maxlength="255"  autofocus placeholder="Masukan Nama Lengkap..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="notandapengenal" value="<?php echo $row->no_tanda_pengenal?>" maxlength="255"  autofocus placeholder="Diisi nomor tanda pengenal..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tempat Lahir</label>
                                    <div class="controls">
                                        : <input type="text" name="tempatlahir" value="<?php echo $row->tempat_lahir?>" maxlength="255"  autofocus placeholder="Masukan Tempat Lahir Penduduk..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Lahir</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggallahir" maxlength="255"  value="<?php echo $row->tanggal_lahir?>" autofocus placeholder="Masukan Tanggal Lahir Penduduk..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="kewarganegaraan" value="<?php echo $row->kewarganegaraan?>" maxlength="255"  autofocus placeholder="Masukan Kewarganegaraan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Asal Penduduk</label>
                                    <div class="controls">
                                        : <input type="text" name="asalpenduduk" value="<?php echo $row->asal_penduduk?>" maxlength="255"  autofocus placeholder="Masukan Asal Penduduk..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tujuan Datang</label>
                                    <div class="controls">
                                        : <input type="text" name="tujuandatang" value="<?php echo $row->tujuan_datang?>" maxlength="255"  autofocus placeholder="Diisi Tujuan Datang Penduduk..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nama Alamat yang didatangi</label>
                                    <div class="controls">
                                        : <input type="text" name="namaalamatyangdidatangi" value="<?php echo $row->alamat_yang_didatangi?>" maxlength="255"  autofocus placeholder="Masukan Nama Alamat yang Didatangi..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Kedatangan</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggalkedatangan" maxlength="255"  autofocus value="<?php echo $row->tanggal_kedatangan;?>" placeholder="Masukan Tanggal Kedatangan..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Kepergian</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggalkepergian" maxlength="255"  autofocus value="<?php echo $row->tanggal_kepergian?>" placeholder="Masukan Tanggal Kepergian..." class="span8">
                                    </div>
                                </div>
                                 <div class="control-group">

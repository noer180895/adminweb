                                ...
                                <div style="border-bottom: solid;">
                                    ...
                                    <td>
                                        <center>
                                            ...
                                            <p class="font"><b>Model A. 2 : Buku Keputusan Kepala Desa</b></p>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="1"
                                        ...
                                        <tbody>
                                                ...
                                                foreach ($ambildata as $row) {
                                                        ...
                                                        <td class='tengah'>".$row->nomor_keputusan_kepala_desa." / ".TanggalIndodua($row->tanggal_keputusan_kepala_desa)."</td>

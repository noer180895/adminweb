                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_F_2_d/Buku_Register_Nikah_Talak_cerai_Rujuk/c_26_buku_register_nikah_talak_cerai_rujuk/" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalregister" maxlength="200" readonly autofocus value="<?php echo $row->tanggal_register?>" placeholder="Diisi tanggal menikah / talak / cerai / rujuk..." class="span8">
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namasuami" maxlength="200" readonly autofocus value="<?php echo $row->nama_suami?>" placeholder="Diisi Nama Suami..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Alamat Suami</label>
                                    <div class="controls">
                                        : <textarea name="alamatsuami" readonly class="span8" placeholder="Diisi Alamat Suami"><?php echo $row->alamat_suami?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor KTP Suami</label>
                                    <div class="controls">
                                        : <input type="number" name="nomorktpsuami" maxlength="200" readonly autofocus value="<?php echo $row->no_ktp_suami?>" placeholder="Diisi Nomor KTP Suami ..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Status Suami</label>
                                    <div class="controls">
                                        : <select name="statussuami" readonly class="span8">
                                            <option value="<?php echo $row->status_suami?>" selected><?php echo $row->status_suami?></option>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggallahirsuami" readonly class="span8" value="<?php echo $row->tanggal_lahir_suami?>" placeholder="Diisi Tanggal Lahir suami"></input>
                                    </div>
                                </div>
                                <div class="control-group">
                                            <label class="control-label" for="basicinput">Pekerjaan</label>
                                            <div class="controls">
                                                : <select name="pekerjaansuami" readonly class="span8">
                                                    <option value="<?php echo $row->pekerjaan_suami?>" selected><?php echo $row->pekerjaan_suami?></option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namaistri" maxlength="200" readonly autofocus value="<?php echo $row->nama_istri?>" placeholder="Diisi Nama Istri..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Alamat Istri</label>
                                    <div class="controls">
                                        : <textarea name="alamatistri" readonly class="span8" placeholder="Diisi Alamat Istri"><?php echo $row->alamat_istri?></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor KTP Istri</label>
                                    <div class="controls">
                                        : <input type="number" name="nomorktpistri" maxlength="200" readonly autofocus value="<?php echo $row->no_ktp_istri?>" placeholder="Diisi Nomor KTP Istri ..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Status Istri</label>
                                    <div class="controls">
                                        : <select name="statusistri" readonly class="span8">
                                            <option value="<?php echo $row->status_istri?>" selected><?php echo $row->status_istri?></option>
                                 ...
                                 <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Lahir</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggallahiristri" readonly class="span8" value="<?php echo $row->tanggal_lahir_istri?>" placeholder="Diisi Tanggal Lahir istri"></input>
                                    </div>
                                </div>
                                <div class="control-group">
                                            <label class="control-label" for="basicinput">Pekerjaan Istri</label>
                                            <div class="controls">
                                                : <select name="pekerjaanistri" readonly class="span8">
                                                    <option value="<?php echo $row->pekerjaan_istri?>" selected><?php echo $row->pekerjaan_istri?></option>
                                                    <option value="Belum / Tidak Bekerja">Belum / Tidak Bekerja </option>
                                                    <option value="Mengurus Rumah Tangga">Mengurus Rumah Tangga</option>
                                                    <option value="Pelajar / Mahasiswa">Pelajar / Mahasiswa</option>
                                                    <option value="Pensiunan">Pensiunan</option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namawali" readonly class="span8" value="<?php echo $row->wali?>" placeholder="Diisi dengan anam Wali"></input>
                                    </div>
                                </div>
                                <div class="control-group">

                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_F_1/Buku_Pengurus_Anggota_Kemasyarakatan/c_26_buku_pengurus_anggota_kemasyarakatan/" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namalembaga" maxlength="200" readonly value="<?php echo $row->nama_lembaga?>" autofocus placeholder="Diisi Nama Lembaga Kemasyarakatan..." class="span8">
                                    </div>
                                </div>
                                <br><br>
                                <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="date" name="tanggalperaturandesa" maxlength="200" readonly value="<?php echo $row->tanggal_peraturan_desa?>" autofocus placeholder="Diisi tanggal Peraturan Desa ..." class="span8">
                                    </div>
                                </div>
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="nomorperaturandesa" maxlength="200" readonly autofocus value="<?php echo $row->nomor_peraturan_desa?>" placeholder="Diisi nomor Peraturan Desa..." class="span8">
                                    </div>
                                </div>
                                </fieldset>
                                <br><br>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namapengurus" maxlength="200" readonly autofocus value="<?php echo $row->nama_pengurus?>" placeholder="Diisi nama pengurus ..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Tanggal Lahir Pengurus</label>
                                    <div class="controls">
                                        : <input type="date" name="tanggallahirpengurus" maxlength="200" readonly autofocus value="<?php echo $row->tanggal_lahir_pengurus?>" placeholder="Diisi Tanggal Lahir Pengurus ..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Agama Pengurus</label>
                                    <div class="controls">
                                        : <select name="agamapengurus" readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="pendidikanpengurus" readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="jabatanpengurus" readonly>

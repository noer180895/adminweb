<?php
  ...
  // $dataWhere = array(
  // 	'tahun' => $tahun , );
  $ambilRekening = $this->m_23_APBDes->template_select('buku_APBDes'); 
?>
  ...
  <div class="modal-dialog">
    ...
    <div id="berubah">
      <div class="modal-body" id="berubah">
        <?php 
          $doto = $this->m_23_APBDes->template_select('buku_APBDes');
        ?>
...
<script type="text/javascript">
    function pilih(id) {
      var nomor_rekening = document.getElementById('dataNorek' + id).innerHTML;
      ...
      document.getElementById('inputNomorRekening').value = nomor_rekening;

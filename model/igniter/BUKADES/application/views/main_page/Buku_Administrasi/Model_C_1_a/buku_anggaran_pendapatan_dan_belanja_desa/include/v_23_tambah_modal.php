...
<form action="" method="POST" >
          ...
          <div class="control-group">
              ...
              <div class="controls">
                  <input type="number" name="txtTahunSebelumnya" id="txtTahunSebelumnya"  value="" class="span4" >
              </div>
          </div>
          <div class="control-group">
              <label class="control-label" for="basicinput">Tahun Berjalan</label>
              <div class="controls">
                  <input type="number" name="txtTahunBerjalan" id="txtTahunBerjalan"  value="" class="span4" >
              </div>
          </div>
          <div class="control-group">

                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            ?>
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_B_1/Buku_Data_Induk_penduduk_Desa/c_26_buku_induk_penduduk_desa/" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="statusperkawinan"  readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="agama"  readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="pekerjaan" class="span8"  readonly>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="kepandaianmembaca"  readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="alamat" class="span8"  readonly><?php echo $row->alamat_lengkap?></textarea>    
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Hubungan Keluarga</label>
                                    <div class="controls">
                                        : <select name="hubungankeluarga"  readonly class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="number" name="nomorktp" maxlength="20"  readonly autofocus value="<?php echo $row->no_ktp?>" placeholder="Masukan Nomor KK..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor KK</label>
                                    <div class="controls">
                                        : <input type="number" name="nomorkk" maxlength="20"  readonly autofocus value="<?php echo $row->no_kk?>" class="span8">
                                    </div>
                                </div>
                                 <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    <label class="control-label" for="basicinput">Keterangan</label>
                                    <div class="controls">
                                        : <textarea name="keterangan" class="span8" placeholder="penjelasan atau catatan lain apabila diperlukan" readonly></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">

                ...
                <div class="span9">
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <form action="<?php echo base_url()?>Buku_Administrasi/Model_B_1/Buku_Data_Induk_penduduk_Desa/c_26_buku_induk_penduduk_desa/simpan" method="POST"  class="form-horizontal row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="text" name="namalengkap" maxlength="255" required autofocus placeholder="Masukan Nama Penduduk..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <select name="kepandaianmembaca" required class="span8">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <textarea name="alamat" class="span8" placeholder="Alamat penduduk"></textarea>    
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        : <input type="number" name="nomorktp" maxlength="20" required autofocus placeholder="Masukan Nomor KK..." class="span8">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Nomor KK</label>
                                    <div class="controls">
                                        : <input type="number" name="nomorkk" maxlength="20" required autofocus placeholder="Masukan Nomor NIK..." class="span8">
                                    </div>
                                </div>
                                 <div class="control-group">

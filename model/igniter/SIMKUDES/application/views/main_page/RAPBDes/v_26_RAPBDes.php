                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>";
                                                            ...
                                                            if ($row->tahun >= $tahunSekarang && $row->grant == 0 ) {
                                                                ?>
                                                                <a href="<?php echo base_url()?>beranda/c_26_beranda/masukTahunGET?tahun=<?php echo $row->tahun ?>"><button style='margin-bottom:5px' class='btn btn-primary'>Buat</button></a>
                                                                <a href="<?php echo base_url()?>RAPBDes/c_26_RAPBDes/hapus?id=<?php echo $row->nomor_perdes?>&tahun=<?php echo $row->tahun ?>"><button style='margin-bottom:5px' onClick='return hapus()' class='btn btn-primary'>Hapus</button></a>
                                                                <?php
                                                            }else{
                                                                if ($row->tahun == date("Y")) {
                                                                    ?>
                                                                        <a class="btn btn-primary" href="<?php echo base_url() ?>APBDes/c_26_APBDes/apbdesPerubahan"> Apbdes Perubahan </a>
                                                                    <?php
                                                                }else{

<script type="text/javascript">
  ...
  function cari2() {
     ...
     var id = document.getElementById('ajihidayat').value;
      ...
      xmlhttp.open("GET", "<?php echo base_url() ?>APBDes/c_23_generateAPBDes/modalUbahUmum?id="+ id,true);
      xmlhttp.send();
  }
  function mati() {
...
<!-- Modal -->
<div class="modal fade" id="modalUbahUmum" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Perubahan Data Buku Kas Umum</h4>
      </div> <!-- # modal-header -->

    <div id="berubah">
      <div class="modal-body" id="berubah">
        <button id="tombolAmbil" onclick="cari2()" class="btn btn-default" >Ambil Data</button>
  ...
  <script>
    $(document).on("click", "#tombolUbah", function () {
         ...
         $("#modalUbahUmum").modal({backdrop: "static"});

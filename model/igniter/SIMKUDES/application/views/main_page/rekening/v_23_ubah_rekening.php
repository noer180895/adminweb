    ...
    <div class="content">
		<div class="module">
            ...
            <div class="module-body">
                    <form action="<?php echo base_url()?>rekening/c_23_rekening/ubah" class="form-horizontal row-fluid" method="POST">
                       ...
                       <div class="module-body table">
                                        ...
                                        <?php
                                            ...
                                            <tr>";
                                                for ($k=1; $k <=10 ; $k++) { 
                                                    $kode = "k".$k;
                                                    echo "
                                                    <td> <input required type='number' name='txtKode".$k."' class='span10' value='".$tampil->$kode."'> </td>
                                                    ";
                                                }
                                            echo
                                                "
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="span8" rows="2"  maxlength="200" name="txtUraian" required><?php echo $tampil->uraian ?> </textarea>
                            </div>
                        </div>

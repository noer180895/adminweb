...
class C_26_APBDes extends CI_Controller
{
	...
	public function keluarAPBDes()
	{
		$this->session->unset_userdata('tahunAPBDes');
		?>
	...
	public function apbdesPerubahan()
	{
		// var_dump("blo");
		// exit();
		$data = array(
			'view' => 'main_page/APBDes/v_23_APBDes_Perubahan' , 

			'ambil' => $this->m_26_APBDes->ambildataPerubahan(), 
			);
	...
	public function hapusPerubahan()
		{
			$id = $_GET['id'];
			$tahun = $_GET['tahun'];
			...
			$this->m_26_APBDes->hapusPerubahan($dataWhere, $dataWhere2);
			...
			$modelData = array(
				...
				echo "<script>
					  alert('Data Perubahan Berhasil dihapus');
